...
public class CoasterPresenterImp <V extends CoasterMvpView> extends BasePresenter<V> implements CoasterMvpPresenter<V> {
    int serverUploadIndex = 0;
    File filetoUpload = null;

    @Inject
    public CoasterPresenterImp(AppDataManager dataManager, CompositeDisposable compositeDisposable) {
