...
public class PublicShippingPresenterImp <V extends PublicShippingMvpView> extends BasePresenter<V> implements PublicShippingMvpPresenter<V>  {
    ...
    @Inject
    public PublicShippingPresenterImp(AppDataManager dataManager, CompositeDisposable compositeDisposable) {
        ...
        getCompositeDisposable().add(getDataManager().
                ...
                .subscribe(selectCountryCitiyListsResponseModel -> {
                    if (selectCountryCitiyListsResponseModel != null && selectCountryCitiyListsResponseModel.getISResultHasData() == 1) {
                        ...
                        PublicShippingPresenterImp.this.getMvpView().returnPatternList(selectCountryCitiyListsResponseModel.getResult());
                    } else {
                        PublicShippingPresenterImp.this.getMvpView().showMessage(R.string.some_error);
                    }
