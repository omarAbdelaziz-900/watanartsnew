...
public class ColorBgMobileAdapter extends RecyclerView.Adapter<ColorBgMobileAdapter.MyViewHolder> {

    protected  ItemListenerOfItems itemListener;
    Context mContext;
    private List<Object> colorItemModels;
    int colorOrStyleType;
    int row_index=-1;

    public ColorBgMobileAdapter(int colorOrStyleType,Context context, List<Object> colorItemModels, ItemListenerOfItems itemListener){
