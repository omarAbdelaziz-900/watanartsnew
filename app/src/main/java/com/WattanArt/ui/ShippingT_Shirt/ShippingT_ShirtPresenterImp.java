...
public class ShippingT_ShirtPresenterImp <V extends ShippingT_ShirtMvpView> extends BasePresenter<V> implements ShippingT_ShirtMvpPresenter<V>  {
    ...
    @Inject
    public ShippingT_ShirtPresenterImp(AppDataManager dataManager, CompositeDisposable compositeDisposable) {
        ...
        getCompositeDisposable().add(getDataManager().
                ...
                .subscribe(selectCountryCitiyListsResponseModel -> {
                    if (selectCountryCitiyListsResponseModel != null && selectCountryCitiyListsResponseModel.getISResultHasData() == 1) {
                        ...
                        ShippingT_ShirtPresenterImp.this.getMvpView().returnPatternList(selectCountryCitiyListsResponseModel.getResult());
                    } else {
                        ShippingT_ShirtPresenterImp.this.getMvpView().showMessage(R.string.some_error);
                    }
