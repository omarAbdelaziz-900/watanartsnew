...
public class ShippingFlashMemoryPresenterImp <V extends ShippingFlashMemoryMvpView> extends BasePresenter<V> implements ShippingFlashMemoryMvpPresenter<V>  {
    ...
    @Inject
    public ShippingFlashMemoryPresenterImp(AppDataManager dataManager, CompositeDisposable compositeDisposable) {
        ...
        getCompositeDisposable().add(getDataManager().
                ...
                .subscribe(selectCountryCitiyListsResponseModel -> {
                    if (selectCountryCitiyListsResponseModel != null && selectCountryCitiyListsResponseModel.getISResultHasData() == 1) {
                        ...
                        ShippingFlashMemoryPresenterImp.this.getMvpView().returnPatternList(selectCountryCitiyListsResponseModel.getResult());
                    } else {
                        ShippingFlashMemoryPresenterImp.this.getMvpView().showMessage(R.string.some_error);
                    }
