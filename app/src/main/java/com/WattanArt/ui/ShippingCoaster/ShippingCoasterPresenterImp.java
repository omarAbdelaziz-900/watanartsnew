...
public class ShippingCoasterPresenterImp <V extends ShippingCoasterMvpView> extends BasePresenter<V> implements ShippingCoasterMvpPresenter<V>  {
    ...
    @Inject
    public ShippingCoasterPresenterImp(AppDataManager dataManager, CompositeDisposable compositeDisposable) {
        ...
        getCompositeDisposable().add(getDataManager().
                ...
                .subscribe(selectCountryCitiyListsResponseModel -> {
                    if (selectCountryCitiyListsResponseModel != null && selectCountryCitiyListsResponseModel.getISResultHasData() == 1) {
                        ...
                        ShippingCoasterPresenterImp.this.getMvpView().returnPatternList(selectCountryCitiyListsResponseModel.getResult());
                    } else {
                        ShippingCoasterPresenterImp.this.getMvpView().showMessage(R.string.some_error);
                    }
