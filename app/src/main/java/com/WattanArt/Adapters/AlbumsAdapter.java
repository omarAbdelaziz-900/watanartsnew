...
import java.util.List;
    ...
    public class AlbumsAdapter extends BaseAdapter<BaseViewHolder> {
        ...
        public AlbumsAdapter(List<AlbumModel.Result> mNewsList, RetryPageLoadHelper retryPageLoadHelper, EmptyCallback emptyCallback) {
...
//                        LayoutInflater.from(parent.getContext()).inflate(R.layout.empty_list_item, parent, false) , mEmptyCallback);
        ...
        public void addDataForList(List<AlbumModel.Result> newDataResultList) {
            if (mItemsList == null) {
...
//            contentTextView = itemView.findViewById(R.id.textViewDescription);
            ...
            public void onBind(int position) {
                ...
                final AlbumModel.Result album = mItemsList.get(position);
