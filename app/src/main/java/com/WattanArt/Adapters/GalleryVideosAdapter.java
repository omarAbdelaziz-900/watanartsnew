...
public class GalleryVideosAdapter extends BaseAdapter<BaseViewHolder> {
    ...
    public GalleryVideosAdapter(List<AlbumModel.Result> mNewsList, RetryPageLoadHelper retryPageLoadHelper, EmptyCallback emptyCallback) {
