...
import com.WattanArt.model.Response.EventModel.Result;
...
public class EventsAdapter extends BaseAdapter<BaseViewHolder> {

    public static final int VIEW_TYPE_EMPTY = 0;
    public static final int VIEW_TYPE_NORMAL = 1;
    public static final int VIEW_TYPE_LOADING = 2;

    private List<EventModel.Result> mItemsList;
    ...
    public EventsAdapter(List<EventModel.Result> mNewsList, RetryPageLoadHelper retryPageLoadHelper, EmptyCallback emptyCallback) {
...
//                        LayoutInflater.from(parent.getContext()).inflate(R.layout.empty_list_item, parent, false) , mEmptyCallback);
    ...
    public void addDataForList(List<EventModel.Result> newDataResultList) {
        if (mItemsList == null) {
    ...
    public void add(Object r) {
        if (mItemsList == null)
            return;
        mItemsList.add((EventModel.Result) r);
    ...
    public void addItems(List<EventModel.Result> albumList) {
        if (mItemsList != null) {
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            final EventModel.Result evetnModel = mItemsList.get(position);
            if (evetnModel == null) return;

//            ImageHelper.loadImageAsThumb(evetnModel.getEventImage(), evetnModel.getEventImage(), R.drawable.img_not_available, coverImageView);
            titleTextView.setText(evetnModel.getName());
            contentTextView.setText(evetnModel.getDescription());
