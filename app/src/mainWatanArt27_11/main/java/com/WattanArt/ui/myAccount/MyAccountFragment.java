package com.WattanArt.ui.myAccount;
...
public class MyAccountFragment extends BaseFragment implements SettingMvpView {
    ...
    @BindView(R.id.my_orders_linear)
    LinearLayout my_orders_linear;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((HomeActivity) Objects.requireNonNull(getActivity())).setToolbarTitle(getString(R.string.my_account));
...
//                    FacebookSdk.sdkInitialize(MyApplication.getAppContext());
    ...
    public void setMy_orders_linear(){
        my_orders_linear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                userId = userData.getUserID(getActivity());
                if (!userId.isEmpty()) {
