...
import com.WattanArt.model.Response.NewsTicker.Result;
...
import java.util.List;
    ...
    public class NewsTickerAdapter extends BaseAdapter<BaseViewHolder> {

        public static final int VIEW_TYPE_EMPTY = 0;
        public static final int VIEW_TYPE_NORMAL = 1;
        public static final int VIEW_TYPE_LOADING = 2;

        private List<NewsTicker.Result> mItemsList;
        ...
        public NewsTickerAdapter(List<NewsTicker.Result> mNewsList, RetryPageLoadHelper retryPageLoadHelper, EmptyCallback emptyCallback) {
...
//                        LayoutInflater.from(parent.getContext()).inflate(R.layout.empty_list_item, parent, false) , mEmptyCallback);
        ...
        public void addDataForList(List<NewsTicker.Result> newDataResultList) {
            if (mItemsList == null) {
        ...
        public void add(Object r) {
            if (mItemsList == null)
                return;
            mItemsList.add((NewsTicker.Result) r);
        ...
        public void addItems(List<NewsTicker.Result> albumList) {
            if (mItemsList != null) {
        ...
        public class ViewHolder extends BaseViewHolder {
            ...
            public void onBind(int position) {
                ...
                final NewsTicker.Result newsTicker = mItemsList.get(position);
                if (newsTicker == null) return;

//                ImageHelper.loadImageAsThumb(newsTicker.getEventImage(), newsTicker.getEventImage(), R.drawable.img_not_available, coverImageView);
//                titleTextView.setText(newsTicker.getEventNameAR());
//                contentTextView.setText(newsTicker.getEventDescriptionAR());
