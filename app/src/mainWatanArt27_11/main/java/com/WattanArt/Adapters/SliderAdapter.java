...
import com.WattanArt.model.Response.SliderModel.Result;
...
public class SliderAdapter extends BaseAdapter<BaseViewHolder> {

    public static final int VIEW_TYPE_EMPTY = 0;
    public static final int VIEW_TYPE_NORMAL = 1;
    public static final int VIEW_TYPE_LOADING = 2;

    private List<SliderModel.Result> mItemsList;
    ...
    public SliderAdapter(List<SliderModel.Result> mNewsList, RetryPageLoadHelper retryPageLoadHelper, EmptyCallback emptyCallback) {
...
//                        LayoutInflater.from(parent.getContext()).inflate(R.layout.empty_list_item, parent, false) , mEmptyCallback);
    ...
    public void addDataForList(List<SliderModel.Result> newDataResultList) {
        if (mItemsList == null) {
    ...
    public void add(Object r) {
        if (mItemsList == null)
            return;
        mItemsList.add((SliderModel.Result) r);
    ...
    public void addItems(List<SliderModel.Result> albumList) {
        if (mItemsList != null) {
...
//            contentTextView = itemView.findViewById(R.id.textViewDescription);
        ...
        public void onBind(int position) {
            ...
            final SliderModel.Result album = mItemsList.get(position);
            if (album == null) return;

//            ImageHelper.loadImageAsThumb(album.getNewsImage(), album.getNewsImage(), R.drawable.img_not_available, coverImageView);
//            titleTextView.setText(album.getNewsTitleAR());
//            contentTextView.setText(album.getNewsDescriptionAR());
