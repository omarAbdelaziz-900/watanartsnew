...
public class UCropView extends FrameLayout  {
    ...
    public void changeBorderVisibilty(){
        if (border.getVisibility() == VISIBLE){
...
//        mViewOverlay.setGesture(mGestureCropImageView);
        a.recycle();
    ...
    private void setListenersToViews() {
        ...
        mViewOverlay.setOverlayViewChangeListener(new OverlayViewChangeListener() {
            ...
            public void onCropRectUpdated(RectF cropRect) {
                ...
                mGestureCropImageView.onFinishRaioChange();

            }
        });


        mViewOverlay.setOnAllThreadsDone(new onAllThreadsDone() {
            @Override
            public void onAllDone() {
               mGestureCropImageView.allCallbacksDone();
            }
        });
    }
    ...
    public void forceResetCropImageView() {
        invalidate();
        requestLayout();
        mGestureCropImageView.requestLayout();
        mViewOverlay.requestLayout();
    }
}