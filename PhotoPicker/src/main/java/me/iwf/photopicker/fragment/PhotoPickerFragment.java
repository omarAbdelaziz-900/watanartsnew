...
public class PhotoPickerFragment extends Fragment {
    ...
    private ArrayList<String> removePhotos;
    ...
    private final static String EXTRA_REMOVE = "remove";
    ...
    public static PhotoPickerFragment newInstance(boolean showCamera, boolean showGif,
                                                  ...
                                                  ArrayList<String> originalPhotos, ArrayList<String> removePhotos) {
        ...
        args.putStringArrayList(EXTRA_REMOVE, removePhotos);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        removePhotos = getArguments().getStringArrayList(EXTRA_REMOVE);
        ...
        photoGridAdapter = new PhotoGridAdapter(getActivity(), mGlideRequestManager, directories, originalPhotos, removePhotos, column);
        ...
        MediaStoreHelper.getPhotoDirs(getActivity(), mediaStoreArgs,
                new MediaStoreHelper.PhotosResultCallback() {
                    ...
                    public void onResultCallback(List<PhotoDirectory> dirs) {
                        ...
                        adjustHeight();
                        if (dirs.size() > 0)
                            btSwitchDirectory.setText(dirs.get(0).getName());

                        //after loading only DCIM load other folders
