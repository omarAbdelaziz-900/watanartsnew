...
public class PhotoPicker {
  ...
  public final static String EXTRA_REMOVE_PHOTOS = "REMOVE_PHOTOS";
  ...
  public static class PhotoPickerBuilder {
    ...
    public PhotoPickerBuilder setRemoval(ArrayList<String> imagesUri) {
      mPickerOptionsBundle.putStringArrayList(EXTRA_REMOVE_PHOTOS, imagesUri);
      return this;
    }
