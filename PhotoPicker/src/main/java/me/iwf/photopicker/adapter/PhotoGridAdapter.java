...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
    ...
    public PhotoGridAdapter(Context context, RequestManager requestManager, List<PhotoDirectory> photoDirectories,
                            ArrayList<String> orginalPhotos, ArrayList<String> removalPhotos, int colNum) {
        ...
        if (removalPhotos != null) deletedPhotos.addAll(removalPhotos);
    }
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
            ...
            if (canLoadImage) {
                ...
                if (FileUtils.isImageLowResolution(photo.getPath())) {
                    holder.iv_resolution.setVisibility(View.VISIBLE);
                    photo.setLowRes(true);
                    photos.get(myPos).setLowRes(true);
                } else {
                    holder.iv_resolution.setVisibility(View.GONE);
                    photo.setLowRes(false);
                    photos.get(myPos).setLowRes(false);
                }
            }
            ...
            final int finalMyPos = myPos;
            holder.vSelected.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (photos.get(finalMyPos).isLowRes()) {
                        Toast toast = Toast.makeText(context, context.getString(R.string.__picker_low_res), Toast.LENGTH_LONG);
    ...
    public int getItemCount() {
        ...
        return photosCount/* - deletedPhotos.size()*/;
    }


    public static class PhotoViewHolder extends RecyclerView.ViewHolder {
        private ImageView ivPhoto, iv_resolution;
        ...
        public PhotoViewHolder(View itemView) {
            ...
            iv_resolution = itemView.findViewById(R.id.iv_resolution);
        }
    }
